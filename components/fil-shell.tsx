...
//   < lg (1024)   : 1 panneau  — centre ; rail en overlay plein écran
//   lg → xl       : 2 panneaux — S1 + le rail REMPLACE le centre (centre masqué)
...
export const RAIL_CLS =
  ...
  'lg:static lg:inset-auto lg:z-auto lg:flex-1 lg:border-l lg:border-border ' +
  'xl:w-[400px] xl:flex-none xl:shrink-0'
// Centre masqué quand le rail est ouvert, UNIQUEMENT en 2 panneaux (lg→xl). En overlay (<lg) et en
// 3 panneaux (≥xl) il reste monté.
export const CENTER_HIDDEN_WHEN_OPEN = 'lg:max-xl:hidden'
