 ...
 * Le A se dessine → le nœud remonte la ligne → étincelle + onde, sur fond orange,
 * puis fondu. Monté une fois par chargement (persiste sur la nav SPA, rejoue au cold start).
    ...
    >
      <svg width={168} height={168} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-label="atline">
        <g transform="translate(17.76,16.52) scale(0.62)">
          ...
          <polygon points="28,64 28,77 68,54.9 68,49.9" fill="#FFFFFF" clipPath="url(#atline-splash-bar)" />

          <circle cx="68" cy="52.4" r="2.6" fill="#FFFFFF" opacity="0">
            <animate attributeName="opacity" values="0;0;1;1;1" keyTimes="0;0.29;0.32;0.92;1" dur="4s" repeatCount="indefinite" />
          </circle>

          {/* étincelle blanche à l'arrivée */}
          <circle cx="81.5" cy="47" r="2" fill="#FFFFFF" opacity="0">
          ...
          {/* onde signal blanche */}
          <circle cx="81.5" cy="47" r="7" fill="none" stroke="#FFFFFF" strokeWidth="2" opacity="0">
            <animate attributeName="r" values="7;7;26;26" keyTimes="0;0.62;0.90;1" dur="4s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;0;0.7;0;0" keyTimes="0;0.62;0.66;0.92;1" dur="4s" repeatCount="indefinite" />
          </circle>

          {/* nœud qui remonte la ligne puis se cale */}
