...
export default function ContactSheet({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      <div className="absolute inset-0 overflow-y-auto bg-background lg:left-auto lg:w-[720px] lg:border-l lg:border-border lg:shadow-2xl lg:animate-slide-in-right">
